...
(function () {
  ...
  koala.makeCircles = function (selector, colorData, onEvent) {
    ...
    let circleArray = dot.childNodes[0].childNodes

    setInterval(function () {
      // for (let i = 0; i < circleArray.length; i++) {
      //   const e = circleArray[i].getBoundingClientRect();
      //   let x = e.left + (e.right - e.left) / 2
      //   let y = e.top

      //   findAndSplit([x-2,y],[x,y])
      // }
      // let x = Math.floor(Math.random()*width)
      // let y = Math.floor(Math.random()*height)
      findAndSplit([Math.floor(Math.random()*width)-1,Math.floor(Math.random()*height)],[Math.floor(Math.random()*width),Math.floor(Math.random()*height)])
      findAndSplit([Math.floor(Math.random()*width)-1,Math.floor(Math.random()*height)],[Math.floor(Math.random()*width),Math.floor(Math.random()*height)])
    }, 50)
  };
})();
